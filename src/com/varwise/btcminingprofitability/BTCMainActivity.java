package com.varwise.btcminingprofitability;
...
public class BTCMainActivity extends MiningActivityBase {
	public static String ABOUT_MESSAGE = "BTC Mining Profitability \n\nBased on coinchoose.com API";
	private static final String API_BASE = "http://www.coinchoose.com/api.php?base=BTC";
